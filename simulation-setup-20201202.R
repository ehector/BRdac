...
source("/Users/ehector/Dropbox/Projects/SpatialExtremes-Brian/simulations/BRdac_func-20201203.R")
...
output <- BRdac(y=Y, covariates_1, covariates_2, covariates_3, locs=s)
