...
List Cscore_all(const double& alpha, const double& phi, const arma::vec& beta_1, const arma::vec& beta_2, const arma::vec& beta_3, 
                const arma::mat& y, const arma::cube& z_1, const arma::cube& z_2, const arma::cube& z_3, 
                const arma::mat& locs){
  static const double pi = 3.14159265359; 
  static const double sqrt_2_pi = pow(2*pi, 0.5);
...
// [[Rcpp::export]]
arma::mat Chessian_all_sum(const double& alpha, const double& phi, const arma::vec& beta_1, const arma::vec& beta_2, const arma::vec& beta_3, 
                           const arma::mat& y, const arma::cube& z_1, const arma::cube& z_2, const arma::cube& z_3, 
                           const arma::mat& locs){
  static const double pi = 3.14159265359; 
  static const double sqrt_2_pi = pow(2*pi, 0.5);
  ...
  int p_2 = beta_2.size();
  int p_3 = beta_3.size();
  arma::mat sensitivity = zeros<mat>(2 + p_1 + p_2 + p_3, 2 + p_1 + p_2 + p_3);
